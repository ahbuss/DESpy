...
from simkit.stats import SimpleStatsTimeVarying, TruncatingSimpleStatsTimeVarying
...
number_in_queue_stat = TruncatingSimpleStatsTimeVarying('number_in_queue', 50000)
number_available_servers_stat = TruncatingSimpleStatsTimeVarying('number_available_servers')
